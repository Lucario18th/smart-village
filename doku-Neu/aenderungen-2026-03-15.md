# Änderungsprotokoll (Stand 2026-03-15)

Dieses Dokument erfasst die zuletzt umgesetzten Änderungen kompakt und nachvollziehbar.

## Datenmodell und Backend

- `Village.statusText` als persistentes Feld eingeführt.
- Migration hinzugefügt: `add_village_status_text`.
...
- Sensorfreigabe für App/Public auf `exposeToApp` ausgerichtet.
- Trennung der Sensor-Flags klar umgesetzt:
  - `isActive` für technischen Aktivstatus,
  - `receiveData` für Datenerfassung,
  - `exposeToApp` für Sichtbarkeit in App/Public.
...
- Nginx-WebSocket-Proxy für `/mqtt` ergänzt.
...
- Polling überschreibt Kartenfilter nicht mehr unbeabsichtigt.
