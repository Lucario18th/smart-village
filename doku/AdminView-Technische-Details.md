...
**Hinweis (Auto-Discovery):** Sensoren und Controller werden über MQTT discovery erstellt. Admins pflegen primär Metadaten (Name, Beschreibung, Position) und schalten Sensoren bzw. den Empfang von Werten ein/aus.
